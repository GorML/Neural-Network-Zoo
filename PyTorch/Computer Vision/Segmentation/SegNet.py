...
class SegNet(Module):
    def __init__(self, in_channels=3, num_classes=11):
        ...
        self.dec_conv53 = Sequential(ConvTranspose2d(512, 512, kernel_size=3, padding=1), BatchNorm2d(512), ReLU())
        self.dec_conv52 = Sequential(ConvTranspose2d(512, 512, kernel_size=3, padding=1), BatchNorm2d(512), ReLU())
        self.dec_conv51 = Sequential(ConvTranspose2d(512, 512, kernel_size=3, padding=1), BatchNorm2d(512), ReLU())
        
        self.unpool4 = MaxUnpool2d(kernel_size=2, stride=2)
        self.dec_conv43 = Sequential(ConvTranspose2d(512, 512, kernel_size=3, padding=1), BatchNorm2d(512), ReLU())
        self.dec_conv42 = Sequential(ConvTranspose2d(512, 512, kernel_size=3, padding=1), BatchNorm2d(512), ReLU())
        self.dec_conv41 = Sequential(ConvTranspose2d(512, 256, kernel_size=3, padding=1), BatchNorm2d(256), ReLU())
        
        self.unpool3 = MaxUnpool2d(kernel_size=2, stride=2)
        self.dec_conv33 = Sequential(ConvTranspose2d(256, 256, kernel_size=3, padding=1), BatchNorm2d(256), ReLU())
        self.dec_conv32 = Sequential(ConvTranspose2d(256, 256, kernel_size=3, padding=1), BatchNorm2d(256), ReLU())
        self.dec_conv31 = Sequential(ConvTranspose2d(256, 128, kernel_size=3, padding=1), BatchNorm2d(128), ReLU())
        
        self.unpool2 = MaxUnpool2d(kernel_size=2, stride=2)
        self.dec_conv22 = Sequential(ConvTranspose2d(128, 128, kernel_size=3, padding=1), BatchNorm2d(128), ReLU())
        self.dec_conv21 = Sequential(ConvTranspose2d(128, 64, kernel_size=3, padding=1), BatchNorm2d(64), ReLU())
        
        self.unpool1 = MaxUnpool2d(kernel_size=2, stride=2)
        self.dec_conv12 = Sequential(ConvTranspose2d(64, 64, kernel_size=3, padding=1), BatchNorm2d(64), ReLU())   
        self.dec_conv11 = Sequential(ConvTranspose2d(64, num_classes, kernel_size=3, padding=1), Softmax())
    ...
    def forward(self, x):
        ...
        # Decoder
        d5 = self.dec_conv1(self.unpool1(e5, e5_idx))
        d4 = self.dec_conv2(self.unpool2(d5, e4_idx))
        d3 = self.dec_conv3(self.unpool3(d4, e3_idx))
        d2 = self.dec_conv4(self.unpool4(d3, e2_idx))
