...
class UNet(Module):
    def __init__(self, in_channels=3, out_channels=2):
        ...
        # Encoder
        self.enc1  = Sequential(ReflectionPad2d(1), Conv2d(in_channels, 64, kernel_size=3), ReLU(),
                                ReflectionPad2d(1), Conv2d(64, 64, kernel_size=3), ReLU())
        self.pool1 = MaxPool2d(kernel_size=2, stride=2)
        
        self.enc2  = Sequential(ReflectionPad2d(1), Conv2d(64, 128, kernel_size=3), ReLU(),
                               ReflectionPad2d(1), Conv2d(128, 128, kernel_size=3), ReLU())
        self.pool2 = MaxPool2d(kernel_size=2, stride=2)
        
        self.enc3  = Sequential(ReflectionPad2d(1), Conv2d(128, 256, kernel_size=3), ReLU(),
                                ReflectionPad2d(1), Conv2d(256, 256, kernel_size=3), ReLU())
        self.pool3 = MaxPool2d(kernel_size=2, stride=2)
        
        self.enc4  = Sequential(ReflectionPad2d(1), Conv2d(256, 512, kernel_size=3), ReLU(),
                                ReflectionPad2d(1), Conv2d(512, 512, kernel_size=3), ReLU())
        self.pool4 = MaxPool2d(kernel_size=2, stride=2)
        
        # Bottleneck
        self.b = Sequential(ReflectionPad2d(1), Conv2d(512, 1024, kernel_size=3), ReLU(),
                            ReflectionPad2d(1), Conv2d(1024, 1024, kernel_size=3), ReLU())

        # Decoder
        self.upconv1 = ConvTranspose2d(1024, 512, kernel_size=2, stride=2)
        self.dec1    = Sequential(ReflectionPad2d(1), Conv2d(1024, 512, kernel_size=3), ReLU(),
                                  ReflectionPad2d(1), Conv2d(512, 512, kernel_size=3), ReLU())
        
        self.upconv2 = ConvTranspose2d(512, 256, kernel_size=2, stride=2)
        self.dec2    = Sequential(ReflectionPad2d(1), Conv2d(512, 256, kernel_size=3), ReLU(),
                                  ReflectionPad2d(1), Conv2d(256, 256, kernel_size=3), ReLU())
        
        self.upconv3 = ConvTranspose2d(256, 128, kernel_size=2, stride=2)
        self.dec3    = Sequential(ReflectionPad2d(1), Conv2d(256, 128, kernel_size=3), ReLU(),
                                  ReflectionPad2d(1), Conv2d(128, 128, kernel_size=3), ReLU())
